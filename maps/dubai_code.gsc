...
_id_7573( var_0 )
{
    ...
    //level._id_1032.helmet = spawn( "script_model", ( 0.0, 0.0, 0.0 ) );
    //level._id_1032.helmet setmodel( "dub_juggernaut_helmet" );
    //level._id_1032.helmet linkto( level._id_1032, "j_head", ( -4.0, 0.0, 2.0 ), ( 0.0, 0.0, 0.0 ) );
}

// _id_7573( var_0 )
// {
//     var_1 = "intro_yuri";
//     var_27 = spawn( "script_model", var_0.origin );
//     var_27 setmodel( "dub_juggernaut_helmet" );
//     var_27._id_1032 = "intro_yuri_helmet";
//     var_27 useanimtree( level._id_1245["intro_yuri_helmet"] );
//     var_33 = getent( "yuri_intro", "targetname" ) maps\_utility::_id_166F( 1 );
//     var_33._id_1032 = "yuri";
//     self hide();
//     var_4 = [];
//     var_4[var_4.size] = self;
//     var_4[var_4.size] = var_33;
//     var_4[var_4.size] = var_27;
//     thread maps\dubai_utils::_id_7446();
//     var_33 thread maps\dubai_utils::_id_7446();
//     var_0 thread maps\_anim::_id_11DE( var_4, var_1 );
//     self waittillmatch( "single anim", "ram_door" );
//     level.player playrumbleonentity( "damage_light" );
//     maps\_audio::aud_send_msg( "dubai_exit_van" );
...
_id_75AB()
{
    ...
    level._id_73D7 setmodel( "body_shadow_co_assault" );
