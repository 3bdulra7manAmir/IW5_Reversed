...
_id_3F72( var_0 ) //HERE
{
    ...
    //level.player setviewmodel( "viewhands_sniper_udt" ); //HERE
    ...
    level.player setweaponammostock( "xm25", 2500 );
	
	level.player giveweapon( "thermite" );
    level.player setweaponammostock( "thermite", 2500 );
}
...
_id_45C8()
{
    ...
    var_1 = missile_createattractororigin( level._id_45C9.origin + ( 0, 0, 64 ), 10000, 10000, level._id_4485 );
...
_id_45DE( var_0 )
{
    ...
    for ( var_9 = 0; var_9 < var_8; var_9++ )
    {
        ...
        self fireweapon( "tag_flash", var_0, ( 0, 0, 0 ), 0.0 );
